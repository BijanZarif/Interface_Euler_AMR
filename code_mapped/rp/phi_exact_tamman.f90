! Returns phi function to obtain zero of exact Euler equations
...
SUBROUTINE phi_exact(gammal,gammar,pr,pl,rho_r,rho_l,ul,ur,pinfl,pinfr,p,phi,& 
    ...
    ! Bar pressure (SEE IVINGS and TORO paper or DEL RAZO and LEVEQUE paper)
    pbl = pl + pinfl
    pbr = pr + pinfr
    ! Star bar pressure
    pbsl = p + pinfl
    ...
    ! Use shockwave phi's from MC IVINGS and TORO's paper (can be used for Tamman too)
