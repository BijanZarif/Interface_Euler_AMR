...
c      =======================================================
c
c     # Set source terms to solve by using operator splitting. 
c     # Axisymmetric equations have exact solution for the source term,
c     # though Runge-Kutta4 integrator is included in case it is needed.
c
...
c     # existence may be required by some compilers.
      ...
      do i=1-mbc,mx+mbc 
        ...
        do j=1-mbc,my+mbc 
            ! Avoid almost singular source terms (improves stability)
            r = ylower + (j-0.5d0)*dy + 5.d0*dy 
            ...
            ! Calculate iteration based on exact solution, see paper.
